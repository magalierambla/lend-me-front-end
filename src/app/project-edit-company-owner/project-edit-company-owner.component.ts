...
import {UserModel, ProjectModel, templteProjectModel, ImageProjectModel,
       AdressReseauxSociauxProjectModel, PorteProjectModel, CategorieProjectModel, ResponseConnectionUserModel} from '../interfaces/models';
...
export class ProjectEditCompanyOwnerComponent implements OnInit {
 ...
 @ViewChild('recaptcha', {static: false }) recaptchaElement: ElementRef;
  ...
  addPhotoForBdd(objectPhoto: ImageProjectModel){
    ...
    this.apiService.addImageProject(this.ObjetResponseConnection, this.ObjetProject.token, objectPhoto).subscribe((data: any) => {
  ...
  deleteImageByProject(indexImage: number, objectPhoto: ImageProjectModel ){
    ...
    this.apiService.deleteImageProject(this.ObjetResponseConnection, this.ObjetProject.token, objectPhoto).subscribe((data: any) => {
  ...
  onFormSubmitUpdateProject(){
   ...
   if (this.ObjetProject.contrePartieProject  && this.isvalidCaptcha    &&  !this.checkContrePartie  && this.isValidDateCollecte){
      ...
      this.apiService.updateDataProjectByUser(this.ObjetResponseConnection, this.ObjetProject).subscribe((data: any) => {
 ...
 getListPorteProject(){
  ...
  getinfosProject(tokenProject) {
     ...
     // tslint:disable-next-line:max-line-length
     this.apiService.getDataProjectForUser(this.ObjetResponseConnection, tokenProject, 'porteur_project').subscribe((dataPorject: ProjectModel) => {
  ...
  getListArrayAdressReseauxSociauxProject() {
   ...
   this.apiService.getListArrayAdressReseauxSociauxProject(this.ObjetResponseConnection, this.ObjetProject.token).subscribe((data: any) => {
  ...
  deleteMediaByProject(indexObjectAdresse , objectAdresse){
    ...
    // tslint:disable-next-line:max-line-length
    this.apiService.deleteAdressReseauSocialProject(this.ObjetResponseConnection, this.ObjetProject.token, objectAdresse).subscribe((data: any) => {
    ...
    if (this.typeMediaWeb){
      ...
      if (this.linkProject){
        ...
        if (checkControlValueMedia){
          ...
          // tslint:disable-next-line:max-line-length
          this.apiService.addAdressReseauSocialProject(this.ObjetResponseConnection, this.ObjetProject.token, objectLinkMedia).subscribe((data: any) => {
 ...
 getAllImageProject() {
    ...
    // tslint:disable-next-line:max-line-length
    this.apiService.getAllImagesByIdProject(this.ObjetResponseConnection, this.ObjetProject.token).subscribe((dataImages: Array<ImageProjectModel>) => {
